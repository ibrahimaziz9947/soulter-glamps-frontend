          ...
          <div className="p-4 border-t border-green-light">
            <div className="flex items-center gap-3 px-4 py-3 text-cream">
              <div className="w-10 h-10 bg-yellow rounded-full flex items-center justify-center">
                <span className="font-bold text-green">AD</span>
              </div>
              <div className="flex-1">
                <p className="font-semibold text-sm">Admin User</p>
                <p className="text-xs text-cream/70">admin@soulterglamps.com</p>
              </div>
            </div>
            <Link
              href="/admin"
    ...
    <div className="flex min-h-screen bg-[#f6f3eb]">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className="lg:hidden bg-white border-b px-4 py-3 flex items-center justify-between sticky top-0 z-30">
          <span className="font-serif font-bold text-green-900">Soulter Admin</span>
          <button
            onClick={() => setSidebarOpen(true)}
